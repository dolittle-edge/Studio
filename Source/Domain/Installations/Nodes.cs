...
namespace Domain.Installations
{
    ...
    {
        static readonly Reason NodeNameAlreadyExists = Reason.Create("aa184789-1c5d-44cd-9890-a292e3993748", "Node '{Node}' already exists");
        static readonly Reason NodeWithNameDoesNotExists = Reason.Create("215b195e-e88a-4457-a7c8-18c3f49e06d1", "Node '{Node}' does not exist");

        readonly List<Node> _nodes = new List<Node>();

        public Nodes(EventSourceId id)
            : base(id)
        {
        }
